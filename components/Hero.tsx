      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-center space-y-6 animate-fade-in">
            ...
            {/* Quick Info Cards */}
            <div className="grid grid-cols-2 gap-4 w-full max-w-[320px] lg:max-w-[340px]">
              <div className="bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 text-center shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
